		...
		<div class="container-fluid">
			...
			<div class="content-wrapper">	
				<section class="content">
					<form role="form" action="adicionaProfissional" method="post" id="form1">
								<div class="box-header with-border">
									<h3 class="box-title col-md-12">Novo Profissional</h3>
								</div>
								<!-- /.box-header -->
								<div class="form-row">
									<div class="form-group col-md-6">
									  <label>Nome do Profissional</label>
									  <input type="text" class="form-control" placeholder="Nome" required="true" name="nome">
									</div>
									<div class="form-group col-md-2">
									  <label>CRO(Número do Conselho)</label>
									  <input type="number" class="form-control" required="true" placeholder="CRO" name="cro">
									</div>
									<div class="form-group col-md-2">
									  <label>Função</label>
									  <input type="text" class="form-control" required="true" placeholder="Função" name="funcao">
									</div>
									<div class="form-group col-md-2">
									  <label>Senha</label>
									  <input type="password" class="form-control" required="true" placeholder="Senha" name="senha">
									</div>
