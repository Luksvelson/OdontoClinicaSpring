		...
		<div class="container-fluid">
			...
			<div class="content-wrapper">	
				<section class="content">
					<form role="form" action="alterarPaciente" method="post" id="form1">
							...
							<div role="tabpanel" class="tab-pane active" id="aba1">
								...
								<div class="form-row">
									<div class="form-group col-md-2">
									  ...
									  <input type="number" class="form-control" placeholder="Id" required="true" name="id_paciente" value="${paciente.id_paciente}" readonly>
									</div>
									<div class="form-group col-md-6">
									  <label>Nome do Paciente</label>
									  <input type="text" class="form-control" placeholder="Nome" required="true" name="nome_paciente" value="${paciente.nome_paciente}">
									</div>
									<div class="form-group col-md-2">
									  <label>CPF</label>
									  <input type="number" class="form-control" required="true" placeholder="CPF" name="cpf" value="${paciente.cpf}">
									</div>
									<div class="form-group col-md-2">
									  <label>RG</label>
									  <input type="number" class="form-control" required="true" placeholder="RG" name="rg" value="${paciente.rg}">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-2">
									  <label>Email</label>
									  <input type="email" class="form-control" placeholder="Email" required="true" name="email" value="${paciente.email}">
									</div>
									<div class="form-group col-md-2">
									  <label>Data de Nascimento</label>
									  <input type="date" class="form-control" required="true" placeholder="Data de Nascimento" name="data_nasc" value="${paciente.data_nasc}">
									</div>
									<div class="form-group col-md-2">
									  <label>Sexo</label>
									...
									<div class="form-group col-md-4">
									  ...
									  <input type="text" class="form-control" placeholder="Nome do Cônjuge" name="nome_conjuge" value="${paciente.nome_conjuge}">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-4">
									  <label>Endereço</label>
									  <input type="text" class="form-control" required="true" placeholder="Endereço" name="endereco" value="${paciente.endereco}">
									</div>
									<div class="form-group col-md-3">
									  <label>Bairro</label>
									  <input type="text" class="form-control" required="true" placeholder="Bairro" name="bairro" value="${paciente.bairro}">
									</div>
									<div class="form-group col-md-3">
									  <label>Cidade</label>
									  <input type="text" class="form-control" required="true" placeholder="Cidade" name="cidade" value="${paciente.cidade}">
									</div>
									<div class="form-group col-md-2">
									  <label>CEP</label>
									  <input type="text" class="form-control" required="true" placeholder="CEP" name="cep" value="${paciente.cep}">
									</div>
								</div>
							</div>
							<!-- /.tabpanel 1 -->
							<div role="tabpanel" class="tab-pane" id="aba2">
								...
								<div class="form-row">
									<div class="form-group col-md-3">
									  ...
									  <input type="text" class="form-control" required="true" placeholder="Estado de saúde" name="estado_saude" value="${paciente.estado_saude}">
									</div>
									<div class="form-group col-md-2">
									...
									<div class="form-group col-md-3">
									  ...
									  <input type="text" class="form-control" placeholder="Alergias" name="alergias" value="${paciente.alergias}">
									</div>
									<div class="form-group col-md-2">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
									  ...
									  <input type="text" class="form-control" placeholder="Problemas" name="prob_resp" value="${paciente.prob_resp}">
									</div>
									<div class="form-group col-md-2">
									...
									<div class="form-group col-md-2">
									  ...
									  <input type="text" class="form-control" placeholder="Cirurgias" name="cirurgias" value="${paciente.cirurgias}">
									</div>
									<div class="form-group col-md-2">
									  <label>Fuma?</label>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
									  <label>Quais Problemas?</label>
									  <input type="text" class="form-control" placeholder="Problemas" name="prob_circ" value="${paciente.prob_circ}">
									</div>
									<div class="form-group col-md-3">
									...
									<div class="form-group col-md-3">
									  ...
									  <input type="text" class="form-control" placeholder="Medicamentos" name="medicamentos" value="${paciente.medicamentos}">
									</div>
								</div>
							</div>
							<!-- /.tabpanel 2 -->
