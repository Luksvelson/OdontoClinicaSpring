							...
							<table class="table table-hover" overflow="scroll">
								...
								<tbody>
									<c:forEach var="paciente" items="${pacientes}">
										<tr data-href="detalharPaciente?id_paciente=${paciente.id_paciente}"> 
											<td><a class="btn btn-primary" href="removerPaciente?id_paciente=${paciente.id_paciente}">Remover</a></td> <td>${paciente.id_paciente}</td> <td>${paciente.nome_paciente}</td> <td>${paciente.cpf}</td> <td>${paciente.rg}</td> 
										</tr> 
									</c:forEach>
								</tbody>
							</table>
	        ...
	        <div class="row">
	            <div class="col-xs-12">
	                <div class="navbar navbar-fixed-bottom" style="padding: 10px 0 60px 21px; background-color: #fff;">
	                    ...
	                    <a href="novoPaciente" role="button" class="btn btn-primary">Novo Paciente</a>
	                </div>
	            </div>
	        </div>
   		</div>
